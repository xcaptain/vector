...
mod tests {
    ...
    #[test]
    fn topology_replace_source_and_sink() {
        for _ in 0..500 {
            let mut rt = runtime();
            ...
            old_config.add_sink("out1", &["in1"], TcpSinkConfig::new(out_addr1.to_string()));
            ...
            new_config.add_sink("out2", &["in2"], TcpSinkConfig::new(out_addr2.to_string()));
